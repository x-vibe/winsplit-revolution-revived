# D�commenter la ligne suivante pour gagner du temps lors des diff�rents tests
#SetCompress off
SetCompressor lzma

# Modifier la ligne ci-dessous pour qu'elle pointe vers le r�pertoire "bin" apr�s compilation du soft et de sa dll
...
# R�cup�rer le dossier d'installation depuis la base de registre si disponible
InstallDirRegKey HKLM "${SOFTWARE_REGKEY}" "path"

# Clefs de registre pour le stockage de la langue utilis�e lors de l'installation
...
# Ic�nes pour l'installateur et le d�sinstallateur
...
# Diff�rentes pages de l'installateur
...
# Diff�rentes pages du d�sinstallateur
...
Function DetectInstalledVersion
	# Comme cette fonction est appel�e depuis le "OnInit", la langue n'est
	# pas encore initialis�e, il faut donc se palucher la traduction � la main.
