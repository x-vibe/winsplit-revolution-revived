...
VirtualNumpad::VirtualNumpad(wxWindow* parent, wxWindowID id, const wxString& title,
...
{
  Connect(
      wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(VirtualNumpad::OnClicEvent), NULL, this);
...
void VirtualNumpad::CreateControls()
{
  ...
  wxBitmapButton* btn1 = new wxBitmapButton(
      p_panel, ID_1, wxBitmap(a1_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
  wxBitmapButton* btn2 = new wxBitmapButton(
      p_panel, ID_2, wxBitmap(a2_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
  wxBitmapButton* btn3 = new wxBitmapButton(
      p_panel, ID_3, wxBitmap(a3_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
  wxBitmapButton* btn4 = new wxBitmapButton(
      p_panel, ID_4, wxBitmap(a4_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
  wxBitmapButton* btn5 = new wxBitmapButton(
      p_panel, ID_5, wxBitmap(a5_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
  wxBitmapButton* btn6 = new wxBitmapButton(
      p_panel, ID_6, wxBitmap(a6_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
  wxBitmapButton* btn7 = new wxBitmapButton(
      p_panel, ID_7, wxBitmap(a7_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
  wxBitmapButton* btn8 = new wxBitmapButton(
      p_panel, ID_8, wxBitmap(a8_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
  wxBitmapButton* btn9 = new wxBitmapButton(
      p_panel, ID_9, wxBitmap(a9_xpm), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW);
