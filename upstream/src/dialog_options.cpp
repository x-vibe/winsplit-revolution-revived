...
OptionsDialog::OptionsDialog(wxWindow* parent)
    : wxDialog(parent, -1, _("Options"), wxDefaultPosition)
...
{
  // If the user closes the window while searching for an update
...
{
  // General Sizer of the page
  wxBoxSizer* pageszr;
  // Variable for different wxStaticBoxSizer's
  wxStaticBoxSizer* stbszr;

  wxPanel* pnlGeneral = new wxPanel(book, -1);
  pageszr = new wxBoxSizer(wxVERTICAL);
  // First zone: the choice of language
  stbszr = new wxStaticBoxSizer(wxHORIZONTAL, pnlGeneral, _("Language"));
  stbszr->Add(new wxStaticText(pnlGeneral, -1, _("Choose language")),
              0,
              wxALL | wxALIGN_CENTER_VERTICAL,
              5);
  p_cmbLanguage = new wxComboBox(
      pnlGeneral, -1, wxEmptyString, wxDefaultPosition, wxSize(150, -1), 0, NULL, wxCB_READONLY);
  ...
  // Third zone: Delete values from auto-placement
  ...
  stbszr->AddStretchSpacer(1);
  p_cmbAutoPlacement = new wxComboBox(
      pnlGeneral, -1, wxEmptyString, wxDefaultPosition, wxSize(180, -1), 0, NULL, wxCB_READONLY);
  stbszr->Add(p_cmbAutoPlacement, 0, wxALL | wxEXPAND, 5);
  pageszr->Add(stbszr, 0, wxALL | wxEXPAND, 5);
  // Fourth zone: temporary files
  ...
  line1->AddSpacer(5);
  p_cmbDeleteTime = new wxComboBox(
      pnlGeneral, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
  ...
  pageszr->Add(stbszr, 0, wxLEFT | wxRIGHT | wxEXPAND, 5);
  // Fifth zone: import / export settings
  ...
  // Fill the combobox for self-placement
...
void OptionsDialog::CreateAndFillPage_Numpad(wxNotebook* book)
{
  ...
  p_checkAutoHide =
      new wxCheckBox(pnlNumpad, -1, _("Hide Virtual numpad after a virtual key selection"));
  ...
  stbszr->Add(new wxStaticText(pnlNumpad, -1, _("Adjust Virtual numpad transparency")),
              0,
              wxALL | wxALIGN_CENTER_HORIZONTAL,
              5);
  p_sliderNumpadTransparency = new wxSlider(pnlNumpad,
                                            -1,
                                            50,
                                            0,
                                            100,
  ...
  stbszr = new wxStaticBoxSizer(wxVERTICAL, pnlNumpad, _("Virtual numpad position"));
  {
    ...
    wxStaticText* stt =
        new wxStaticText(pnlNumpad,
                         -1,
                         _("Sometimes, the virtual numpad ends up outside of the screen.\nYou can "
                           "restore its position to the center of the screen."));
...
void OptionsDialog::CreateAndFillPage_WebUpdate(wxNotebook* book)
{
  ...
  p_cmbUpdate = new wxComboBox(
      pnlUpdates, -1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
  ...
  pageszr->Add(stbszr, 0, wxALL | wxEXPAND, 5);
  // Second zone: manual update
  stbszr = new wxStaticBoxSizer(wxHORIZONTAL, pnlUpdates, _("Manual check :"));
  stbszr->Add(new wxStaticText(pnlUpdates, -1, _("Perform a manual web update check now")),
              0,
              wxALL | wxALIGN_CENTER_VERTICAL,
              5);
...
void OptionsDialog::CreateAndFillPage_DragNGo(wxNotebook* book)
{
  ...
  *p_txtDnGRadius << m_options.getDnGDetectionRadius();
  ...
  pageszr->Add(stbszr, 0, wxALL | wxEXPAND, 5);
  // Second zone: the style
  stbszr = new wxStaticBoxSizer(wxVERTICAL, pnlDragNGo, _("Destination zone style :"));
  grdszr = new wxFlexGridSizer(2, 2, 2, 2);
  grdszr->Add(new wxStaticText(
                  pnlDragNGo, wxID_ANY, _("Click here to select preview zone background color :")),
              0,
              wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT);
  p_pnlZoneBgColor =
      new wxPanel(pnlDragNGo, wxID_ANY, wxDefaultPosition, wxSize(20, 20), wxBORDER_STATIC);
  p_pnlZoneBgColor->SetBackgroundColour(m_options.getDnGZoneBgColor());
  grdszr->Add(p_pnlZoneBgColor, 0, wxALL | wxEXPAND, 0);
  grdszr->Add(
      new wxStaticText(pnlDragNGo, wxID_ANY, _("Click here to select preview zone text color :")),
      0,
      wxALIGN_CENTER_VERTICAL | wxALIGN_RIGHT);
  p_pnlZoneFgColor =
      new wxPanel(pnlDragNGo, wxID_ANY, wxDefaultPosition, wxSize(20, 20), wxBORDER_STATIC);
  ...
  stbszr->Add(new wxStaticText(pnlDragNGo, wxID_ANY, _("Adjust destination zone transparency")),
              0,
              wxTOP | wxALIGN_CENTER_HORIZONTAL,
              5);
  p_sliderZoneTransparency = new wxSlider(pnlDragNGo,
                                          -1,
                                          50,
                                          0,
                                          100,
  ...
  p_cmbModifier1 = new wxComboBox(pnlDragNGo,
                                  ...
                                  NULL,
                                  wxCB_READONLY);
  p_cmbModifier2 = new wxComboBox(pnlDragNGo,
                                  wxID_ANY,
                                  wxEmptyString,
                                  wxDefaultPosition,
                                  wxDefaultSize,
  ...
  hszr->Add(new wxStaticText(pnlDragNGo, wxID_ANY, _("Modifier to active Drag'N'Go :")),
            0,
            wxALL | wxALIGN_CENTER_VERTICAL,
            5);
  hszr->Add(p_cmbModifier1, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);
  hszr->Add(
      new wxStaticText(pnlDragNGo, wxID_ANY, _T ("+")), 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);
...
void OptionsDialog::CreateAndFillPage_Misc(wxNotebook* book)
{
  ...
  stbszr = new wxStaticBoxSizer(
      wxVERTICAL, pnlMisc, _("Windows 'Active Window Tracking' built-in functionality :"));
  label = new wxStaticText(
      pnlMisc, -1, _("Any modification here needs at least a session restart to take effect."));
  stbszr->Add(label, 0, wxALL | wxEXPAND, 5);
  p_checkEnableXMouse = new wxCheckBox(
      pnlMisc, wxID_ANY, _("Enable the Windows 'Active Window Tracking' built-in functionality."));
  ...
  lnszr->AddSpacer(20);
  p_checkEnableZOrder = new wxCheckBox(
      pnlMisc, wxID_ANY, _("Active Window Tracking will bring the window to the top."));
  ...
  lnszr = new wxBoxSizer(wxHORIZONTAL);
  // lnszr->AddSpacer(20);
  p_sttZOrderDelay = new wxStaticText(
      pnlMisc, -1, _("Delay before the action of the 'Active Window Tracking' (milliseconds):"));
  ...
  p_checkFollowWnd =
      new wxCheckBox(pnlMisc, wxID_ANY, _("Move the mouse pointer to follow the active window."));
  p_checkFollowWnd->SetValue(m_options.getMouseFollowWindow());
  stbszr->Add(p_checkFollowWnd, 0, wxALL | wxEXPAND, 5);
  lnszr = new wxBoxSizer(wxHORIZONTAL);
  lnszr->AddSpacer(20);
  p_checkFollowOnlyIn = new wxCheckBox(
      pnlMisc, wxID_ANY, _("Move the mouse pointer only if it is over the active window's area"));
  ...
  p_checkMinMaxCycle = new wxCheckBox(
      pnlMisc,
      wxID_ANY,
      _("Minimize and Maximize hotkeys gives a 'Minimize / Maximize / Restored' state cycle."));
...
{
  // General page
  p_cmbLanguage->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                         wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                         NULL,
                         this);
  p_checkTmw->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                      wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                      NULL,
                      this);
  p_btnDeleteAuto->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(OptionsDialog::OnDeleteAutoPlacementClicked),
                           NULL,
                           this);
  p_checkDelTmpFiles->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                              wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                              NULL,
                              this);
  p_cmbDeleteTime->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                           wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                           NULL,
                           this);
  p_btnOpenFolder->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(OptionsDialog::OnOpenScreenshotsFolder),
                           NULL,
                           this);
  p_btnExportOpt->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(OptionsDialog::OnExportSettings),
                          NULL,
                          this);
  p_btnImportOpt->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(OptionsDialog::OnImportSettings),
                          NULL,
                          this);

  // Virtual numpad page
  p_checkSaveVirtNumpad->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                                 wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                                 NULL,
                                 this);
  p_checkShowVirtStart->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                                wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                                NULL,
                                this);
  p_checkAutoHide->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                           wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                           NULL,
                           this);
  p_sliderNumpadTransparency->Connect(wxEVT_SCROLL_CHANGED,
                                      wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                                      NULL,
                                      this);
  p_btnNumpadRestorePosition->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                      wxCommandEventHandler(OptionsDialog::OnNumpadRestoreClicked),
                                      NULL,
                                      this);

  // Web update page
  p_checkUpdate->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                         wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                         NULL,
                         this);
  p_cmbUpdate->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                       wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                       NULL,
                       this);
  p_btnCheckNow->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                         wxCommandEventHandler(OptionsDialog::OnManualUpdatesCheck),
                         NULL,
                         this);

  // Drag'N'Go page
  p_checkEnableDnG->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                            wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                            NULL,
                            this);
  p_txtDnGRadius->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                          wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                          NULL,
                          this);
  p_pnlZoneBgColor->Connect(
      wxEVT_LEFT_UP, wxMouseEventHandler(OptionsDialog::OnSelectPanelColor), NULL, this);
  p_pnlZoneFgColor->Connect(
      wxEVT_LEFT_UP, wxMouseEventHandler(OptionsDialog::OnSelectPanelColor), NULL, this);
  p_sliderZoneTransparency->Connect(wxEVT_SCROLL_CHANGED,
                                    wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                                    NULL,
                                    this);
  p_cmbModifier1->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                          wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                          NULL,
                          this);
  p_cmbModifier2->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                          wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                          NULL,
                          this);

  // Misc page
  p_checkEnableXMouse->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                               wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                               NULL,
                               this);
  p_checkEnableZOrder->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                               wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                               NULL,
                               this);
  p_txtZOrderDelay->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                            wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                            NULL,
                            this);
  p_checkFollowWnd->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                            wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                            NULL,
                            this);
  p_checkFollowOnlyIn->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                               wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                               NULL,
                               this);
  p_checkMinMaxCycle->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                              wxCommandEventHandler(OptionsDialog::OnSomethingHasChanged),
                              NULL,
                              this);

  // OK and Apply buttons
  p_btnApply->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                      wxCommandEventHandler(OptionsDialog::OnApplyOrOkClicked),
                      NULL,
                      this);
  p_btnOk->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                   wxCommandEventHandler(OptionsDialog::OnApplyOrOkClicked),
                   NULL,
                   this);
...
void OptionsDialog::OnSomethingHasChanged(wxCommandEvent& event)
{
  ...
  if (id == p_cmbLanguage->GetId()) {
    // Only activate the "Apply" button if a selection has changed
...
bool OptionsDialog::ApplyChanges()
{
  ...
  if (p_cmbModifier1->GetCurrentSelection() == p_cmbModifier2->GetCurrentSelection()) {
    if ((p_cmbModifier1->GetCurrentSelection() != 0)) {
      wxMessageBox(
          _("The two modifiers must be different"), _("WinSplit message"), wxICON_EXCLAMATION);
      return false;
    }
  }
  // Check the value of the detection radius
  // For Drag'n'Go is Ok, otherwise we do not save any options
  ...
  if (l < 20) {
    ...
    m_options.setDnGDetectionRadius((int)l);
...
{
  if (!p_updateThread) {
    // timeout = 5 because should quickly recover version.txt file
  ...
  if (p_updateThread->IsRunning()) {
    ...
    wxString newVersion = p_updateThread->GetVersionString();
    wxString releaseUrl = p_updateThread->GetReleaseUrl();
    wxString releaseNotes = p_updateThread->GetReleaseNotes();
    ...
    if (!newVersion.IsEmpty()) {
      if (host_version > local_version) {
        ...
        UpdateNotificationDialog dialog(this,
            wxGetApp().GetVersion(),
            newVersion,
            releaseUrl,
            releaseNotes);
        ...
        NoUpdateDialog dialog(this, wxGetApp().GetVersion());
        dialog.ShowModal();
      }
    }
    else {
      wxMessageBox(_("Unable to check for updates.\nPlease check your internet connection."),
                   _T ("WinSplit Revolution"),
                   wxICON_EXCLAMATION);
    }
...
void OptionsDialog::OnExportSettings(wxCommandEvent& event)
{
  ...
  if (!f_out.IsOk()) {
    wxMessageBox(
        _("There was an error while creating the export file !"), _("Error"), wxICON_EXCLAMATION);
    return;
  }
...
void OptionsDialog::OnImportSettings(wxCommandEvent& event)
{
  ...
  if (!f_in.IsOk()) {
    wxMessageBox(
        _("There was an error while opening the export file !"), _("Error"), wxICON_EXCLAMATION);
    return;
  }
