...
void AboutDialog::CreateControls()
{
  ...
  wxTextCtrl* ptxtAbout = new wxTextCtrl(this,
                                         ID_TEXTABOUT,
                                         wxEmptyString,
                                         wxDefaultPosition,
                                         wxSize(370, 260),
                                         wxTE_READONLY | wxTE_AUTO_URL | wxTE_MULTILINE |
                                             wxTE_CENTRE | wxSTATIC_BORDER | wxTE_RICH2);
  ...
  *ptxtAbout << _T ("https://github.com/x-vibe/winsplit-revolution-revived");
  ...
  wxBitmapButton* pbmpBtnWX =
      new wxBitmapButton(this, ID_BITMAPWX, bitmapwx, wxDefaultPosition, wxDefaultSize);
  wxBitmapButton* pbmpBtnCC =
      new wxBitmapButton(this, ID_BITMAPCC, bitmapcc, wxDefaultPosition, wxDefaultSize);
  ...
  wxStaticLine* stcLine =
      new wxStaticLine(this, ID_STATIC, wxDefaultPosition, wxSize(150, -1), wxLI_HORIZONTAL);
